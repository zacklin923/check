...
<div class="layout-wrapper">
    ...
    <!--工具栏开始-->
        <div id="menulist">
                ...
                <a href="#"> <span class="iterm1"></span>导入数据 </a><a href="#"><span class="iterm2"></span>编辑数据</a><a href="#"><span class="iterm3"></span>删除数据</a><a href="#"><span class="iterm4"></span>批量删除</a><a href="#"><span class="iterm5"></span>查询</a>
   ...
   <!-- 工具结束 -->
    ...
    <!--提交表单栏开始-->
                ...
                <div id="self_hidden">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <label for="" style="font-size: 12px">条码</label>
                    <input id="searchbox" style="width:40%;height: 26px">&nbsp;&nbsp;<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="" style="= font-size: 12px">名称</label>
                    <input style="width:40%;margin-top:10px;height: 26px">&nbsp;&nbsp;
                    <div   class="radio">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" style="margin-left:5px">按客户省份汇总&nbsp;<input type="checkbox" style="margin-left:5px">按客户汇总&nbsp;<input type="checkbox" style="margin-left:5px">总签收率
