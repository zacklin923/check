		...
		<div id="mbedit"class="easyui-dialog" style="width:650px;height:700px;padding:10px 20px"
				...
				<form id="moduleform" method="post">
					...
					<table style="margin-left:35px">
						...
						<tr>
						<td><input style="width:150px;" name ="orderline" type="number" min="1" max="25"/>是否超时</td>
						<td><input style="width:150px;margin-left:50px;" name ="orderline" type="number" min="1" max="25"/>签收时间</td>
						</tr>
						<tr>
						...
						<td><input style="width:150px;margin-left:50px;" name ="orderline" type="number" min="1" max="25"/>客户店铺</td>
						</tr>
						<tr>
						<td><input style="width:150px;" name ="orderline" type="number" min="1" max="25"/>收件人</td>
						<td><input style="width:150px;margin-left:50px;" name ="orderline" type="number" min="1" max="25"/>联系方式</td>
						</tr>
						<tr>
						<td><input style="width:150px;" name ="orderline" type="number" min="1" max="25"/>重量</td>
						<td><input style="width:150px;margin-left:50px;" name ="orderline" type="number" min="1" max="25"/>快递公司</td>
						</tr>
						<tr>
						...
						<td><input style="width:150px;margin-left:50px;" name ="orderline" type="number" min="1" max="25"/>所属大区</td>
						</tr>
						<tr>
						<td><input style="width:150px;" name ="orderline" type="number" min="1" max="25"/>所属区部</td>
