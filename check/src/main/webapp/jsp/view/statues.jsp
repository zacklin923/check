...
<div class="layout-wrapper">
    ...
    <!--工具栏开始-->
        <div id="menulist">
            <a href="#"><span class="iterm1"></span>导入数据 </a><a href="#"><span class="iterm2"></span>编辑模板</a><a href="#"><span class="iterm3"></span>编辑数据</a><a href="#"><span class="iterm4"></span>保存</a><a href="#"><span class="iterm5"></span>查询</a><a href="#"><span class="iterm6"></span>统计</a><a href="#"><span class="iterm7"></span>导出</a>
        </div>
   <!-- 工具结束 -->
    ...
    <!--提交表单栏开始-->
                ...
                <div id="self_hidden">
                    ...
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="">所属分拨点</label>
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="">省份</label>
                    <input type="text">
                    <br>

                    &nbsp;<label for="">所属大区</label>
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="">所属区部</label>
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="">地址</label>
                    <input type="text">
                    <br>
                    &nbsp;<label for="">客户店铺</label>
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="">所属分部</label>
                    <input type="text">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="">状态</label>
                    <select name="" id="" style="width: 190px;height: 23px; margin: 5px 10px;border-radius: 5px; border: 1px solid gray;padding-left: 5px;border: 1px solid #95B8E7;text-indent: 27px">
                        <option value="">--请选择发货状态--</option>
                        <option value="">--已发货--</option>
                        <option value="">--未发货--</option>
                    </select>
                    <br/>
                    &nbsp;<label for="">签收站点</label>
                    <input type="text">
                    <div   class="radio">
                        <label for="">运单状太</label>&nbsp;&nbsp;
                        <input type="checkbox" style="margin-left:5px">配送成功	&nbsp;<input type="checkbox" style="margin-left:5px">配送失败	&nbsp;<input type="checkbox" style="margin-left:5px">揽件
                    &nbsp;<input type="checkbox" style="margin-left:5px">配送异常	&nbsp;<input type="checkbox" style="margin-left:5px">配送中	&nbsp;<input type="checkbox" style="margin-left:5px">退回件
                    </div>
                    <div style="margin: 5px"></div>
                    &nbsp;<label for="" style="font-size: 12px">快递单号</label>
                    <input id="searchbox" style="width:60%;height: 26px"><br/>
                    &nbsp;<label for="" style="= font-size: 12px">客户条码</label>
                    <input style="width:60%;margin-top:10px;height: 26px">
                </div>
            </form>
