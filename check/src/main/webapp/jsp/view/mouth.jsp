...
<div class="layout-wrapper">
    ...
    <!--工具栏开始-->
        <div id="menulist">
            <a href="#"><span class="iterm1"></span>导入数据 </a><a href="#"><span class="iterm2"></span>编辑模板</a><a href="#"><span class="iterm3"></span>查询</a>
        </div>
   <!-- 工具结束 -->
    ...
    <!--提交表单栏开始-->
                ...
                <div   class="radio">
                    <label for="">统计方式</label>&nbsp;&nbsp;<input type="checkbox" style="margin-left:5px">大区	&nbsp;<input type="checkbox" style="margin-left:5px">区部	&nbsp;<input type="checkbox" style="margin-left:5px">分部&nbsp;<input type="checkbox" style="margin-left:5px">条码
