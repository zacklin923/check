...
<div class="layout-wrapper">
    ...
    <!--工具栏开始-->
        <div id="menulist">
            <a href="#"><span class="iterm1"></span>导入数据 </a><a href="#"><span class="iterm2"></span>查询</a><a href="#"><span class="iterm3"></span>统计</a>
        </div>
   <!-- 工具结束 -->
    ...
    <!--提交表单栏开始-->
                ...
                <div id="self_hidden">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>操作表名</label>&nbsp;&nbsp;&nbsp;
                    <select name="" id="" style="height: 23px;width: 180px;box-shadow: 1px 1px 2px #E6E6E6 inset;border: 1px solid #ccc;">
                        <option value="">--请选择--</option>
                        <option value="">--运单信息状态表--</option>
                        <option value="">--数据导入--</option>
                    </select>
                    <br>
                    <label>操作类型</label>
                    <input type="text">
